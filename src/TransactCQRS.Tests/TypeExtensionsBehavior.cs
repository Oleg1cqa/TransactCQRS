...
namespace TransactCQRS.Tests
{
	public class TypeExtensionsBehavior
	{
		...
		public void ShouldCorrectGetCsName()
		{
			...
			Assert.Equal("TransactCQRS.IReference<TransactCQRS.Tests.TypeExtensionsBehavior>",
			...
			Assert.Equal("TransactCQRS.Tests.TypeExtensionsBehavior.Test", typeof(Test).ToCsDeclaration());
			Assert.Equal("TransactCQRS.Tests.TypeExtensionsBehavior.Test.MyStruct", typeof(Test.MyStruct).ToCsDeclaration());
